                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Employés Enregistrés</h4>
                            ...
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="d-flex justify-content-between pb-2">
                                        ...
                                        <span>Départements des Employés</span>
                                    </div>
                                </div>
							...
							<div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <select class="custome-select border-0 pr-3">
                                        ...
                                        <tr>
                                            ...
                                            if($stats==1){
                                             ?>
                                                 <span style="color: green">Approuvée <i class="fa fa-check-square-o"></i></span>
                                                 <?php } if($stats==2)  { ?>
                                                <span style="color: red">Refusée <i class="fa fa-times"></i></span>
                                                 <?php } if($stats==0)  { ?>
