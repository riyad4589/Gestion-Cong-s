                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Liste des Demandes en Attente</span></li>
                                    ...
                                    <div class="card">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->PostingDate);?></td>
                                                ...
                                                if($stats==1){
                                             ?>
                                                 <span style="color: green">Approuvé <i class="fa fa-thumbs-o-up"></i></span>
                                                 <?php } if($stats==2)  { ?>
                                                <span style="color: red">Refusé <i class="fa fa-thumbs-o-down"></i></span>
                                                 <?php } if($stats==0)  { ?>
